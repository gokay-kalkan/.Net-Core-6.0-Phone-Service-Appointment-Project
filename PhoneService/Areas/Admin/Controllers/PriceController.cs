    ...
    public class PriceController : Controller
    {
        ...
        public IActionResult Create(PriceCreateDto priceCreateDto)
        {
            ...
            if (result.IsValid)
            {
                ...
                TempData["Success"] = "Price the insertion was successful";
        ...
        public IActionResult Delete(int id)
        {
            ...
            TempData["FullDelete"] = "The delete price process was successful";
        ...
        public IActionResult Update(PriceUpdateDto priceUpdateDto)
        {
            ...
            if (result.IsValid)
            {
                ...
                TempData["Update"] = "the price update process was successful";
            }
