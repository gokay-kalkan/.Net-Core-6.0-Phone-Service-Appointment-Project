    ...
    public class CityController : Controller
    {
        ...
        public IActionResult Create(CityCreateDto createCityDto)
        {
            ...
            if (result.IsValid)
            {
                ...
                TempData["Success"] = "City the insertion was successful";
        ...
        public IActionResult Delete(int id)
        {
            ...
            TempData["FullDelete"] = "The delete city process was successful";
        ...
        public IActionResult Update(CityUpdateDto cityUpdateDto)
        {
            ...
            if (result.IsValid)
            {
                ...
                TempData["Update"] = "the city update process was successful";
