    ...
    public class DealerController : Controller
    {
        ...
        public IActionResult Create(DealerCreateDto dealerCreateDto)
        {
            ...
            if (result.IsValid)
            {
                ...
                TempData["Success"] = "Bayi ekleme işlemi başarıyla gerçekleşti";
        ...
        public IActionResult Delete(int id)
        {
            ...
            TempData["FullDelete"] = "Bayi silme işlemi başarıyla gerçekleşti";
        ...
        public IActionResult Update(DealerUpdateDto dealerUpdateDto)
        {
            ...
            if (result.IsValid)
            {
                ...
                TempData["Update"] = "Bayi güncelleme işlemi başarıyla gerçekleşti";
